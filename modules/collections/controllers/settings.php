...
class settings extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Collections.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('Collections.Settings.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_collections())
			{
				...
				Template::redirect(SITE_AREA .'/settings/collections');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/settings/collections');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Collections.Settings.Edit');
		...
		{
			$this->auth->restrict('Collections.Settings.Delete');
