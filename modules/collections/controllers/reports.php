...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Collections.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Collections.Reports.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_collections())
			{
				...
				Template::redirect(SITE_AREA .'/reports/collections');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/collections');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Collections.Reports.Edit');
		...
		{
			$this->auth->restrict('Collections.Reports.Delete');
