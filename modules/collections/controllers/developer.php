...
class developer extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Collections.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('Collections.Developer.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_collections())
			{
				...
				Template::redirect(SITE_AREA .'/developer/collections');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/collections');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Collections.Developer.Edit');
		...
		{
			$this->auth->restrict('Collections.Developer.Delete');
	...
	*/
	private function save_collections($type='insert', $id=0)
	{
		...
		$this->form_validation->set_rules('collections_have','Have','required');
		$this->form_validation->set_rules('collections_wish','Wish','required|max_length[2]');
