...
<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
    <fieldset>
        ...
        <div class="form-actions">
            ...
            or <?php echo anchor(SITE_AREA .'/settings/collections', lang('collections_cancel'), 'class="btn btn-warning"'); ?>
            

    <?php if ($this->auth->has_permission('Collections.Settings.Delete')) : ?>
