...
<?php $options = array(
        ...
        <div class="form-actions">
            <br/>
            <input type="submit" name="save" class="btn btn-primary" value="Create Coins" />
            or <?php echo anchor(SITE_AREA .'/developer/coins', lang('coins_cancel'), 'class="btn btn-warning"'); ?>
