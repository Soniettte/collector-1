<div class="admin-box">
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			<thead>
				<tr>
					<?php if ($this->auth->has_permission('Coins.Settings.Delete') && isset($records) && is_array($records) && count($records)) : ?>
			...
			<tfoot>
				<?php if ($this->auth->has_permission('Coins.Settings.Delete')) : ?>
				<tr>
					<td colspan="9">
			...
			<?php foreach ($records as $record) : ?>
				...
				<?php if ($this->auth->has_permission('Coins.Settings.Edit')) : ?>
				<td><?php echo anchor(SITE_AREA .'/settings/coins/edit/'. $record->id, '<i class="icon-pencil">&nbsp;</i>' .  $value) ?></td>
				<?php else: ?>
