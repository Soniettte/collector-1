...
class content extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Coins.Content.View');
		$this->load->model('coins_model', null, true);
		$this->load->model('collections/collections_model', null, true);
	...
	*/
	public function index()
	{
		...
		$this->db->join('collections', 'coins.id = collections.collections_coin_id', 'left');
		$records = $this->coins_model->find_all();
	...
	*/
	public function have() {
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/content/coins');
		}
		
		$this->load->module('collections/content');
		$this->controller->edit_copy();
	...
	*/
	...
	{
		$this->auth->restrict('Coins.Content.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_coins())
			{
				...
				Template::redirect(SITE_AREA .'/content/coins');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Coins.Content.Edit');
		...
		{
			$this->auth->restrict('Coins.Content.Delete');
