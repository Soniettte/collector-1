...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Coins.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Coins.Reports.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_coins())
			{
				...
				Template::redirect(SITE_AREA .'/reports/coins');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/coins');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Coins.Reports.Edit');
		...
		{
			$this->auth->restrict('Coins.Reports.Delete');
