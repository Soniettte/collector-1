...
class settings extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Coins.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('Coins.Settings.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_coins())
			{
				...
				Template::redirect(SITE_AREA .'/settings/coins');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/settings/coins');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Coins.Settings.Edit');
		...
		{
			$this->auth->restrict('Coins.Settings.Delete');
